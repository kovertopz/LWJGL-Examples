 ...
 */
public class OpenGL_1_5_Vertex_Buffer_Objects {

    private final static float MOUSE_POLL = 1.0f / 125.0f;
    private final static float PI_OVER_180 = (float) Math.PI / 180.0f;
    private final static String WINDOW_TITLE = "OpenGL 1.5 Vertex Buffer Objects";
    ...
    public static void main(String[] args) {
        OpenGL_1_5_Vertex_Buffer_Objects example = new OpenGL_1_5_Vertex_Buffer_Objects();
        example.start();
    }
