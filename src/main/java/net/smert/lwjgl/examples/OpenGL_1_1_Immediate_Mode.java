...
public class OpenGL_1_1_Immediate_Mode {
    ...
    public static void main(String[] args) {
        OpenGL_1_1_Immediate_Mode example = new OpenGL_1_1_Immediate_Mode();
        example.start();
    }
    ...
    private void mainLoop() {
        ...
        while (exampleRunning) {
            ...
            input(delta);
            updateCamera();
            drawCubeWithTriangles(-2.0f, 0.0f, 0.0f);
            drawCubeWithQuads(2.0f, 0.0f, 0.0f);
            drawCubeWithQuadsAndDifferentColorsPerVertex(0.0f, 2.0f, 0.0f);
            updateFPS();
    ...
    private void drawCubeWithTriangles(float x, float y, float z) {
        GL11.glPushMatrix();
    ...
    private void drawCubeWithQuads(float x, float y, float z) {
        GL11.glPushMatrix();
    ...
    private void drawCubeWithQuadsAndDifferentColorsPerVertex(float x, float y, float z) {
        GL11.glPushMatrix();
