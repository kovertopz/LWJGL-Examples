 ...
 */
public class OpenGL_3_0_Vertex_Buffer_Objects_Compatibility_Mode {

    private final static float MOUSE_POLL = 1.0f / 125.0f;
    private final static String WINDOW_TITLE = "OpenGL 3.0 Vertex Buffer Objects Compatibility Mode";
    ...
    public static void main(String[] args) {
        OpenGL_3_0_Vertex_Buffer_Objects_Compatibility_Mode example = new OpenGL_3_0_Vertex_Buffer_Objects_Compatibility_Mode();
        example.start();
    }
