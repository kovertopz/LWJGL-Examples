...
public class NeheLesson03 {
    ...
    public static void main(String[] args) {
        NeheLesson03 jlesson03 = new NeheLesson03();
        jlesson03.run(args);
    }
    ...
    private void render() {
        ...
        GL11.glColor3f(1.0f, 0.0f, 0.0f);                                       // Set the color to red (NEW)
        GL11.glVertex3f(0.0f, 1.0f, 0.0f);                                      // Top
        GL11.glColor3f(0.0f, 1.0f, 0.0f);                                       // Set the color to green (NEW)
        GL11.glVertex3f(-1.0f, -1.0f, 0.0f);                                    // Bottom left
        GL11.glColor3f(0.0f, 0.0f, 1.0f);                                       // Set the color to blue (NEW)
        ...
        GL11.glColor3f(0.25f, 0.25f, 1.0f);                                     // Set the color to blue for all verticies (NEW)
